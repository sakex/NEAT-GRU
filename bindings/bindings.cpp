...
EMSCRIPTEN_EXPORT void
fit(void *s, int const iterations, int const max_individuals, int const max_species, int const max_layers,
...
EMSCRIPTEN_EXPORT double
topology_delta_compatibility(NeuralNetwork::Topology const *top1, NeuralNetwork::Topology const *top2) {
